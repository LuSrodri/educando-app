              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <Input
                    value={shareUrl}
                    readOnly
                    className="bg-gray-50 text-sm min-w-0 flex-1"
                  />
                  <Button
                    onClick={copyLink}
                    variant="outline"
                    className={`shrink-0 ${copied ? "border-green-500 text-green-700" : ""}`}
                  >
                    {copied ? (
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                  <Button
                    ...
                    variant="outline"
                    className="flex flex-col items-center gap-1 h-auto py-2 sm:py-3 hover:bg-green-50 hover:border-green-300"
                  >
                  ...
                  <Button
                    ...
                    variant="outline"
                    className="flex flex-col items-center gap-1 h-auto py-2 sm:py-3 hover:bg-blue-50 hover:border-blue-300"
                  >
                  ...
                  <Button
                    ...
                    variant="outline"
                    className="flex flex-col items-center gap-1 h-auto py-2 sm:py-3 hover:bg-sky-50 hover:border-sky-300"
                  >
                  ...
                  <div className="flex gap-3">
                    ...
                    <div className="flex-1 min-w-0 overflow-hidden">
                      <p className="font-medium text-gray-900 text-sm truncate">
                        Atividade: {truncateTitle(activityTitle, 35)}
                      </p>
